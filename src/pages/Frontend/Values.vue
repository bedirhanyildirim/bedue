    ...
    <section class="w-full flex justify-center relative">
      ...
      <div class="z-[1] max-w-screen-md lg:max-w-screen-xl px-4 xl:px-0 w-full flex flex-col-reverse lg:flex-row justify-between lg:items-center py-20 saturate-100">
        <div class="w-full lg:w-3/4">
          <!-- <h1 class="uppercase text-center lg:text-left text-2xl md:text-5xl font-bold">VALUES</h1> -->
          <h1 class="uppercase text-center lg:text-left text-2xl md:text-5xl font-bold">DEĞERLERİMİZ</h1>
        </div>
      </div>
    </section>
    <section class="w-full flex flex-col justify-between items-center">
      <div class="w-full max-w-screen-xl px-4 xl:px-0 py-10 md:py-20 flex flex-col md:flex-row justify-between">
        <div class="w-full lg:w-2/3 lg:pr-4">
          <ul class="text-black block text-lg list-disc list-inside">
            <li>Doğruluk</li>
            <li>Dürüstlük</li>
            <li>Güvenilirlik</li>
            <li>Tarafsızlık</li>
            ...
            <li>Tutarlılık</li>
            <li>Yenilikçilik</li>
            <li>Tutkulu çalışma</li>
            <li>Yasal ve etik kurallara uyma</li>
        </ul>
        </div>
      </div>
    </section>
